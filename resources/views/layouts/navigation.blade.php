        ...
        <div class="tw-flex tw-justify-between tw-h-16">
            ...
            <div class="tw-hidden sm:tw-flex sm:tw-items-center sm:tw-ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="tw-inline-flex tw-items-center tw-px-3 tw-py-2 tw-border tw-border-transparent tw-text-sm tw-leading-4 tw-font-medium tw-rounded-md tw-text-gray-500 tw-bg-white tw-hover:text-gray-700 tw-focus:outline-none tw-transition tw-ease-in-out tw-duration-150">
                            <div>{{ Auth::user()->name }}</div>

                            <div class="tw-ms-1">
                                <svg class="fill-current tw-h-4 tw-w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <div class="tw-me-2 tw-flex tw-items-center sm:tw-hidden">
                <button @click="open = ! open" class="tw-inline-flex tw-items-center tw-justify-center tw-p-2 tw-rounded-md tw-text-gray-400 tw-hover:tw-text-gray-500 tw-hover:tw-bg-gray-100 tw-focus:tw-outline-none tw-focus:tw-bg-gray-100 tw-focus:tw-text-gray-500 tw-transition tw-duration-150 tw-ease-in-out">
