    ...
    <div class="col-xl-3 col-sm-6 col-12">
      <div class="card board1 fill">
        <div class="card-body">
          <div class="dash-widget-header">
            <div>
              <h3 class="card_widget_header">{{ $nb_categories }}</h3>
              ...
              @foreach($recent_articles as $recent)
                <tr>
                  <td class="text-nowrap">
                    <img src="{{ $recent->imageUrl() }}" alt="{{ $recent->slug }}" style="width: 64px; height: 64px; object-fit: contain">
                  </td>
                  <td>{{ $recent->title }}</td>
                  <td>{{ $recent->category->name }}</td>
                  <td>{{ $recent->author->name }}</td>
                </tr>
              @endforeach
              </tbody>
            </table>
